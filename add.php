...
<article>
          <br>
         <h1 style="text-align:center;font-size:160%;">เพิ่มอุปกรณ์ในระบบ</h1>
             <h2 style="text-align:center;font-size:160%;">เพิ่ม</h2>
                <div class="m" style="text-align:center;">
                <form action="add_db.php" method="post">
                  <label for="item_id">รหัสอุปกรณ์:</label><br>
                 <input type="text" id="item_id" name="item_id"><br>
                 <label for="item_name">ชื่ออุปกรณ์</label><br>
